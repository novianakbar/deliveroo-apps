    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          ...
          />
          <Text className="flex-1">Deliver in 10-15 min</Text>
          <TouchableOpacity>
        ...
        <ScrollView>
          {Object.entries(groupedItemInBasket).map(([key, value]) => (
            <View
              key={key}
              className="flex-row items-center space-x-3 px-5 py-2 bg-white "
            >
              <Text className="font-bold">{value.length} x</Text>
              <Image
        ...
        <View className="p-5 bg-white space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="text-red-400 font-semibold">
              -{" "}
              <Currency quantity={11000} currency="IDR" pattern="! #,##0.00" />
            </Text>
          </View>
          <View className="flex-row justify-between">
